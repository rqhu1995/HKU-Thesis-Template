...
\text{s.t.}\quad
& p_{i,1} = \begin{aligned}[t]
      &p_{i}^{0} - \sum\limits_{k \in K}y_{i,1,k}^{\mathrm{u}^{-}}
      + \sum\limits_{k \in K}y_{i,1,k}^{\mathrm{u}^{+}}\\
      &{} + \sum\limits_{m \in R}g_{i,1,m}
      \end{aligned},
...
& b_{i,1} = \begin{aligned}[t]
      &b_{i}^{0} - \sum\limits_{k \in K}y_{i,1,k}^{\mathrm{b}^{-}}
      + \sum\limits_{k \in K}y_{i,1,k}^{\mathrm{b}^{+}}\\
      &{} - \sum\limits_{m \in R}g_{i,1,m}
      \end{aligned},
