...
\leq F\left( {p_{i}',b_{i}'} \right),
&& \forall\left( {p_{i}',b_{i}'} \right) \in \theta\setminus \left\{ \left( {p_{i},b_{i}} \right) \right\} \tag{A.75}\\
& \alpha_{p_{i},b_{i}}^{i} \cdot p_{i} + \beta_{p_{i},b_{i}}^{i} \cdot b_{i} + \gamma_{p_{i},b_{i}}^{i}
= F\left( {p_{i},b_{i}} \right) - s
&& \tag{A.76}\\
...
&& \begin{aligned}[t]
        ...
        \mid p_{i} \geq 0,\ b_{i} \geq 0,\ p_{i} + b_{i} \leq C_{i} \right\},\\
        &\forall i \in S.
        \end{aligned}
\tag{A.79}
\end{modelalign}
